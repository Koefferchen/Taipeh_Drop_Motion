...
dataset_01 = np.genfromtxt("../Data/data_week_03.CSV", delimiter=";", skip_header=2)
...
close_plot(ax, "../Figures/week_03_lengths.jpg")
...
for i in range(5):
    draw_data(ax, 
        ...
        f"$_{i:.0f}$", ".-", colors[i], 10, 0, 2)
close_plot(ax, "../Figures/week_03_widths.jpg")
...
close_plot(ax, "../Figures/week_03_both.jpg")
...
close_plot(ax, "../Figures/week_03_both_avg.jpg")
...
close_plot(ax, "../Figures/week_03_both_fit.jpg")
