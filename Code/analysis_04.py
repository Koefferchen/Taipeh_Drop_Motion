...
close_plot(ax, "../Figures/w04_04mm_lengths.jpg")

    # widths vs volume
ax = init_plot()
draw_grid()
draw_text(ax, r"Drop Volume $V$ / $\mu$l", r"Contact Width / mm")
add_textbox(ax, "$4$mm Cylinder", [0.97, 0.03], 12, "right", "bottom", draw_box=True)
for i in range(5):
    draw_data(ax, 
        volume[index==i], volume_err[index==i], width[index==i], width_err[index==i],
        f"$_{i:.0f}$", ".-", colors[i], 10, 0, 2)
close_plot(ax, "../Figures/w04_04mm_widths.jpg")

    # both vs volume
ax = init_plot()
draw_grid()
draw_text(ax, r"Drop Volume $V$ / $\mu$l", r"Contact Length or Width / mm")
add_textbox(ax, "$4$mm Cylinder", [0.97, 0.03], 12, "right", "bottom", draw_box=True)
for i in range(5):
    draw_data(ax, 
        volume[index==i], volume_err[index==i], length[index==i], length_err[index==i],
...
close_plot(ax, "../Figures/w04_04mm_both.jpg")
...
close_plot(ax, "../Figures/w04_04mm_both_avg.jpg")
...
close_plot(ax, "../Figures/w04_04mm_ratio.jpg")
...
close_plot(ax, "../Figures/w04_04mm_both_fit.jpg")
...
for i in range(6):
    draw_data(ax, 
        volume[index==i], volume_err[index==i], length[index==i], length_err[index==i],
        f"$_{i:.0f}$", ".-", colors[i], 10, 0, 2)
close_plot(ax, "../Figures/w04_10mm_lengths.jpg")
...
for i in range(6):
    draw_data(ax, 
        volume[index==i], volume_err[index==i], width[index==i], width_err[index==i],
        f"$_{i:.0f}$", ".-", colors[i], 10, 0, 2)
close_plot(ax, "../Figures/w04_10mm_widths.jpg")
...
draw_data(ax, [], None, [], None, "Lengths", ".-", "black", 10, 0, 2)
draw_data(ax, [], None, [], None, "Widths", ".--", "black", 10, 0, 2)
close_plot(ax, "../Figures/w04_10mm_both.jpg")
...
close_plot(ax, "../Figures/w04_10mm_both_avg.jpg")
...
close_plot(ax, "../Figures/w04_10mm_ratio.jpg")
...
draw_data(ax, *fit_l, f"Length Fit $(\\chi^2 = {chi_l:.4f})$", "-", orange, 0, 0, 4, alpha=0.5)
draw_data(ax, *fit_w, f"Width Fit $(\\chi^2 = {chi_w:.4f}$)", "-", teal, 0, 0, 4, alpha=0.5)
close_plot(ax, "../Figures/w04_10mm_both_fit.jpg")
...
close_plot(ax, "../Figures/w04_ratios.jpg")
...
close_plot(ax, "../Figures/w04_both_avg.jpg")